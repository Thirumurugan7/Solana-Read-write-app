...
export const StudentIntroList: FC = () => {
    ...
    useEffect(() => {
       connection.getProgramAccounts(new web3.PublicKey(STUDENT_INTRO_PROGRAM_ID)).then(async (account) => {
        const studentIntros: StudentIntro[] = account.reduce((accum: StudentIntro[], {pubkey, account} ) => {
